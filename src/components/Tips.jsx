      ...
      <div className="flex flex-wrap gap-8 justify-center w-full ">
        {chefTips.map((tip, idx) => (
          <div
            ...
            className="bg-white shadow-lg rounded-2xl p-7 flex flex-col items-center w-[300px] transition-transform duration-300 hover:scale-105 hover:bg-orange-50 hover:shadow-xl border-2 border-orange-100 opacity-0 translate-y-10"
          ...
          >
            ...
            <div className="w-16 h-16 mb-4 rounded-full overflow-hidden border-2 border-orange-500 flex items-center justify-center shadow">
              <img src={tip.img} alt={tip.chef + ' icon'} className="w-full h-full object-cover" />
            </div>
